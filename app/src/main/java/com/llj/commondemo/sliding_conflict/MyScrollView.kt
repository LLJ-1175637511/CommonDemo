...
//                val isChildScrolledTop = detY > 0 && !childView.canScrollVertically(-1)
                ...
                Log.d(TAG,"detY > 0:${detY > 0} childView.canScrollVertically(-1):${childView.canScrollVertically(-1)} detY < 0:${detY < 0} childView.canScrollVertically(1):${childView.canScrollVertically(1)}")
